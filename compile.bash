...
# May be needed to recompile with MPI
#rm -fr build
...
cmake --build build --target wheel && pip install --user build/python/dist/${project_name}-0.1.1-py3-none-any.whl --force-reinstall
