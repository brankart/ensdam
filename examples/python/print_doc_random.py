...
# Print documentation
print(edam.random.__doc__)
print(edam.random.seed.__doc__)
print(edam.random.seed_save.__doc__)
print(edam.random.seed_load.__doc__)
print(edam.random.check.__doc__)
print(edam.random.swap.__doc__)
print(edam.random.uniform.__doc__)
print(edam.random.normal.__doc__)
print(edam.random.exp.__doc__)
print(edam.random.gamma.__doc__)
print(edam.random.beta.__doc__)
print(edam.random.truncated_exp.__doc__)
print(edam.random.truncated_normal.__doc__)
print(edam.random.truncated_normal_vec.__doc__)
print(edam.random.field1d_init.__doc__)
